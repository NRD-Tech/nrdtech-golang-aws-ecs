...
from setup_lib.apply_templates import apply_go_mod_module, apply_main_go
...
def main():
    ...
    parser.add_argument("--app-type", choices=constants.APP_TYPES, help="api | internal_api | background_service | scheduled")
    ...
    apply_main_go(args.app_type, args.app_name)
